...
<%@include file="/jsp/xuewei/funclist.jsp"%>
...
<%--                <option value="编译原理" ${queryCourseName == "编译原理" ? "selected=\"selected\"":"" }>编译原理</option>--%>
            ...
            <a href="${pageContext.request.contextPath }/jsp/admin/qadd.jsp">添加题目</a>
        </form>
    </div>
    <!--通用表格样式-->
    <table class="commonTable" cellpadding="0" cellspacing="0" style="table-layout: fixed">
        <tr class="firstTr">
            ...
            <th style="width: 8%; overflow: hidden">题目类型</th>
            <th style="width: 10%; overflow: hidden">关键字</th>
            <th style="width: 32%; overflow: hidden">题目描述</th>
            <th style="width: 32%; overflow: hidden">答案</th>
            <th style="width: 8%; overflow: hidden">操作</th>
        </tr>
        <c:forEach var="question" items="${questionList}" varStatus="status">
            <tr>
                ...
                <td>
                    <span><a class="modifyQuestion" href="javascript:;" qid=${question.id}><img src="${pageContext.request.contextPath }/images/xiugai.png" alt="修改" title="修改"/></a></span>
                    <span><a class="deleteQuestion" href="javascript:;" qid=${question.id}><img src="${pageContext.request.contextPath }/images/schu.png" alt="删除" title="删除"/></a></span>
                </td>
            </tr>
        </c:forEach>
    </table>
